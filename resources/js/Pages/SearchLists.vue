                    ...
                    <li v-for="post in posts" :key="post.id">
                        <a :href="`/posts/${post.id}`" class="flex border rounded-lg m-3 place-items-center">
                            <div class="flex">
                                <div class="w-1/3 p-3">
                                    <div class="gap-3">
                                        <div class="flex items-center">
                                            <img :src="user.profile_photo_url" class="rounded-full h-8 w-8 object-cover mr-2" />
                                            <p class="text-ls">{{ post.user.name }}</p>
                                        </div>

                                        <!-- <img :src="post.image" alt="post image" class="w-32 h-32 rounded-lg" /> -->
                                        <div class="p-2">
                                            <p class="text-xl font-bol">{{ post.title}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-1/3 p-3">
                                ...
                                <div class="w-1/3">
                                    <img src="/images/articlePost.png" alt="Membership Image" class="w-full h-full object-cover rounded-r-lg">
                                </div>
